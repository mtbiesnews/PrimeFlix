...
public class HomeCatAdapter extends RecyclerView.Adapter<HomeCatAdapter.ItemRowHolder> {
    ...
    public void onBindViewHolder(final ItemRowHolder holder, final int position) {
        ...
        Glide.with(mContext).load(singleItem.getCategoryImageUrl()).placeholder(R.drawable.loading).centerCrop().diskCacheStrategy(DiskCacheStrategy.DATA).into(holder.image);
