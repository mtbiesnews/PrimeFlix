...
//        holder.text.setText(filename[position]);
        ...
        Glide.with(mContext).load(Uri.fromFile(new File(filepath[position]))).placeholder(R.mipmap.app_icon).centerCrop().diskCacheStrategy(DiskCacheStrategy.DATA).into(holder.image);
