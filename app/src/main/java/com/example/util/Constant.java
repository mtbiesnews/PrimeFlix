...
import static com.example.config.config.social_main_server_url;
...
public class Constant implements Serializable{
	...
	public static final String BASE_URL= "http://mtbiesnews.co.uk/";
	public static final String createCareer= BASE_URL+"user/create";
	public static final String login= BASE_URL+"user/login";
	public static final String businessCareer= BASE_URL+"business/create";

	// social url
	public static final String social_user_server_url = social_main_server_url+"user/";

	//server url
	public static final String SERVER_URL= BuildConfig.server_url;
	public static final String SERVER_LIVE="http://mtbiesnews.co.uk/";
	...
	public static final String PROFILE = SERVER_LIVE+"user/getprofile";
