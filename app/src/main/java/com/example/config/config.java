...
public class config {
    ...
    public static final String main = "http://netflixvideo.mtbiesnews.com";
//    public static String mainurl = "http://www.battleworld.in/netklix/play/";
    public static final String mainurl = "http://netflixvideo.mtbiesnews.com";
    ...
    public static final String appurl = "http://netflixvideo.mtbiesnews.com";

    public static final String  social_main_server_url = "http://mtbiesnews.co.uk/";
