...
public class ActivityAboutUs extends AppCompatActivity {
    ...
    private void setResult() {
        ...
        Glide.with(ActivityAboutUs.this).load(Constant.IMAGE_PATH_URL + itemAbout.getAppLogo()).placeholder(R.drawable.loading).centerCrop().diskCacheStrategy(DiskCacheStrategy.DATA).into(imgAppLogo);
