...
public class NotificationDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (image.length()>5) {
            Glide.with(NotificationDetailsActivity.this).load(Constant.IMAGE_PATH_URL + image).placeholder(R.drawable.loading).centerCrop().diskCacheStrategy(DiskCacheStrategy.DATA).into(topImage);
        }
